...
TEST_PLAN_BAR = (
    ...
    "source of truth, not the current implementation; if the code's actual "
    "behavior conflicts with the requirement, write the test case against "
    "the requirement anyway. Write steps a QA engineer can execute "
