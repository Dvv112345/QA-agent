...
| `/sprints/:id/nonfunctional-runs/:runId`       | `NonfunctionalRunDetailPage` | One requirement's nonfunctional run: findings with their rule and URL, a per-URL panel of four-valued domain outcomes and measurements, and a per-load-profile panel showing what was actually sent; restart or retry the summary; file or retry bug findings |
